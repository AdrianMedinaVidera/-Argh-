...
public class EnemigoTerrestreJefe extends EnemigoTerrestre{
    ...
    public void ataque1(Personaje personaje) {
        ...
        } else if (jefeSeleccionado.equals("Trex")) {
        ...
        } else if (jefeSeleccionado.equals("Rajoy")) {
    ...
    public void ataque2(Personaje personaje) {
        if (jefeSeleccionado.equals("Casuario")) {
            ...
            // El casuario resurge de las cenizas cual Fénix y restaura y/o aumenta su vida en 100 y aumenta su velocidad y daño en 20, pero reduce sus resistencias un 10%
            vida += 100;
            dañoFisico += 20;
            dañoMagico += 20;
            velocidad += 20;
            ...
            velocidad *= 8.77; //Aumentar la velocidad 8.77 veces es semejante a aumentarla un 777%
        }
    }
...
public class EnemigoTerrestreJefe extends EnemigoTerrestre {
    ...
    public void ataque2(Personaje personaje) {
        if (jefeSeleccionado.equals("Loco")) {
            ...
            // El sapo llama a sus amigos para que le ayuden, aumentando su vida y correr en
            // 20 y quitando el sangrado.
            vida += 20;
            correr += 20;
            estaSangrando = false;
        }
    ...
    public void ataque3(Personaje personaje) {
        if (jefeSeleccionado.equals("Loco")) {
            ...
            // El loco lanza acude a los cangrejos para hacer 35 de daño mágico y deja
            // sangrado
            personaje.setVida(personaje.getVida()
                    - (int) (0.5 * (dañoMagico - personaje.getResistenciaMagica()) + (35 * correr / 100)));
            personaje.setEstaSangrando(true);

        } else if (jefeSeleccionado.equals("Emú")) {
            System.out.println("El jefe enemigo ha usado el ataque Tormenta Celeste");
            // El emú crea una tormenta que no permite ver al enemigo, dejándolo somnoliento
            // y realizando 25 de daño mágico.
            personaje.setVida(personaje.getVida()
                    - (int) (0.5 * (dañoMagico - personaje.getResistenciaMagica()) + (25 * correr / 100)));
            personaje.setEstaSomnoliento(true);
        } else if (jefeSeleccionado.equals("Sapo")) {
            System.out.println("El jefe enemigo ha usado el ataque Lluvia de Babas");
            // El sapo genera una tormenta que segrega babas tóxicas que realizan 50 de daño
            // mágico y ralentizan al personaje en 20.
            personaje.setVida(personaje.getVida()
                    - (int) (0.5 * (dañoMagico - personaje.getResistenciaMagica()) + (50 * correr / 100)));
